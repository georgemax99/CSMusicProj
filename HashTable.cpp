...
void HashTable::addSong(string songName, string songArtist, string songAlbum){
...
string HashTable::shuffle(){
  Song* temp = randomSong();
  string comma = ",";
  string song = temp->name + comma + temp->artist + comma + temp->album;
  return song;
}
